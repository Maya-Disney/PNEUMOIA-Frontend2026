...
const CATEGORIES = ["Toutes","Compte","IA","Technique","Exportation","Inscription"];
const CAT_COLORS = {
  "Compte":"#185FA5","IA":"#7C3AED","Technique":"#D97706",
  "Exportation":"#0891B2","Inscription":brand.DEFAULT,
};
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex flex-col gap-2 shrink-0">
                      ...
                      <button onClick={async ()=>{
                          ...
                          try {
                            const created = await publierQuestionFAQ(q.id, q.reponse.trim(), q.categorie || "Compte");
          ...
          <div className={`w-full max-w-sm rounded-2xl border shadow-2xl overflow-hidden ${dark?"bg-[#161b22] border-[#21262d]":"bg-white border-gray-200"}`}>
            <div className={`flex items-center justify-between px-5 py-4 border-b ${dark?"border-[#21262d]":"border-gray-100"}`}>
              <div>
                ...
                <p className={`text-[12px] mt-0.5 ${dark?"text-[#484f58]":"text-gray-400"}`}>Photo d'identité · {modalePhoto.ville}</p>
              </div>
            ...
            <div className="px-5 py-4 flex flex-col items-center gap-4">
              {modalePhoto.photo_url
                ? <img src={modalePhoto.photo_url} alt={modalePhoto.medecin} className="w-full max-h-[42vh] rounded-xl object-contain border-2 border-gray-200 shadow"/>
              ...
              <div className="text-center">
                ...
                <p className={`text-[13px] mt-0.5 ${dark?"text-[#484f58]":"text-gray-400"}`}>{modalePhoto.cnom} · {modalePhoto.hopital}</p>
              </div>
            </div>
